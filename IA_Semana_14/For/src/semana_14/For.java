...
public class For extends JFrame implements ActionListener {
	...
	public For() {
		setTitle("Estructura de repetión: for");
	...
	protected void actionPerformedBtnA(ActionEvent arg0) {
		/**
			Genere 15 números naturales al azar de dos dígitos.
	...
	protected void actionPerformedBtnC(ActionEvent arg0) {
		/**
			Muestre y sume los 30 primeros términos de la serie:
			5  10  15  20  25  . . .
		 */
		int serie = 5, suma = 0;
		for (int i=1; i<=30; i++) {
	...
	protected void actionPerformedBtnD(ActionEvent arg0) {
		/**
		   Muestre y sume los 25 primeros términos de la serie:
		...
		imprimir("");
		imprimir("La suma de los 25 primeros términos es : " + suma);
	}
	...
	protected void actionPerformedBtnE(ActionEvent arg0) {
		...
		imprimir("");
		imprimir("La suma de los 30 primeros términos es : " + suma);
	}
